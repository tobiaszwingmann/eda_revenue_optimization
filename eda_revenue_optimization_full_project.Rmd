...
weekly_raw_tbl %>%
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
Das Ergebnis: Nein, der CTR-Mittelwert pro Kalenderwoche ist über den Zeitverlauf gesehen relativ konstant. Hier schein kein Muster vorzuliegen.

Schankt die CTR nach Seiten-URL, performen also manche Seiten besser als andere?
```{r}
...
# 3.5.1 Regressionsmodellierung zur Vorhersage der Klicks in Abhängigkeit von Seitenaufrufen
...
scores_df %>% 
  ggplot(aes(x=Score_CTR, y=Score_RPC, color=Handlungsfeld, size=Pageviews)) +
  geom_point() +
